...
class MBAutoEntry(QWidget):
    ...
    def save_production(self):
        ...
        # 2. Determine Mode (Save vs Update)
        is_update = (self.save_btn.text() == "Update")

        # 3. Collect Data
        try:
            # Header Data (Matching tbl_production01)
            header = {
                ...
                'index_no': self.formulation_index.text().strip(),  # WIP No
            ...
            # Quantity Data (Matching tbl_production_quantity)
            quantity = {
            ...
            # Encode Data (Matching tbl_production_encode)
            encode = {
