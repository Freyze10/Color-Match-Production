...
class CMFRecords(QWidget):
    # Signal to pass the CMF number to the parent (CMFModule)
    ...
    def show_context_menu(self, pos):
        ...
        update_record = menu.addAction(fa.icon('fa5s.history', color=AppStyles.BLUE_600), "Update Record Status")
        ...
        if action == edit_cmf:
            ...
            self.request_update.emit(cmf_no)
